...
ALTER TABLE public.clues RENAME CONSTRAINT keywords_pkey TO clues_pkey;
ALTER TABLE public.annotations ADD clue SERIAL NOT NULL;
ALTER TABLE public.annotations ADD CONSTRAINT annotations_clue_fk FOREIGN KEY (clue) REFERENCES public.clues(id);
